...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post salaries_url, params: { salary: { descripcion: @salary.descripcion, fecha: @salary.fecha, valor: @salary.valor } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { descripcion: @salary.descripcion, fecha: @salary.fecha, valor: @salary.valor } }
